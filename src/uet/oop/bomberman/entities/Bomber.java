...
public class Bomber extends Entity {
    ...
    public void update() {
        ...
        if( collision.checkCollision(this,BombermanGame.getEnemy()) instanceof Balloom){
            checkdead=true;
        }
        if( collision.checkCollision(this,BombermanGame.getEnemy()) instanceof Oneal){
            checkdead=true;
        }
        if(checkdead){
            if(timedead>0){
        ...
        if(collision.checkCollision(this,BombermanGame.getItemList())
                instanceof uet.oop.bomberman.entities.Item.BombItem){
            timeBombItem = 1000;
            BombItem = true;
            collision.checkCollision(this, BombermanGame.getItemList()).check = true;
        }
